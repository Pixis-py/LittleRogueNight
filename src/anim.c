...
/* ----------------------------------------------------- Initialisations ----------------------------------------------------- */
 ...
 int x = 0, y = 0, w = 0 , h = 0, b = 0; // Initialisation des coordonnées communes à chaque animation
...
/* ----------------------------------------------------- Animation ----------------------------------------------------- */
 ...
 printf("m1 : %d %d, m2 : %d %d, m3 : %d %d, m4 : %d %d\n", 

 meatpos.x, meatpos.y,

 meatpos2.x, meatpos2.y,

 meatpos3.x, meatpos3.y,

 meatpos4.x, meatpos4.y);
 ...
 printf("j1 : %d %d, j2 : %d %d, j3 : %d %d, j4 : %d %d\n\n", 

 janipos.x, janipos.y,

 janipos2.x, janipos2.y,

 janipos3.x, janipos3.y,

 janipos4.x, janipos4.y);
