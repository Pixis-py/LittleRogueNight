...
\newglossaryentry{spawn}{
    name= spawn,
    description={Verbe qui signifie apparaître, ou un nom qui signifie apparition.}
}
\begin{document}
...
\\
   ...
   \begin{center}
        \includegraphics[width=5cm]{mort_un.png}
        \includegraphics[width=5cm]{mort_deux.png}
        \label{fig13}\\
    \end{center}
   \end{itemize}
\clearpage
